...
open class KarageAPIClientAPIConfiguration: @unchecked Sendable {
    ...
    public init(
        basePath: String = "https://api-qa1.karage.co",
    ...
    public static let shared = KarageAPIClientAPIConfiguration()
}
...
open class RequestBuilder<T: Sendable>: @unchecked Sendable, Identifiable {
    ...
    public let apiConfiguration: KarageAPIClientAPIConfiguration

    /// Optional block to obtain a reference to the request's progress instance when available.
    public var onProgressReady: ((Progress) -> Void)?

    required public init(method: String, URLString: String, parameters: [String: any Sendable]?, headers: [String: String] = [:], requiresAuthentication: Bool, apiConfiguration: KarageAPIClientAPIConfiguration = KarageAPIClientAPIConfiguration.shared) {
        self.method = method
