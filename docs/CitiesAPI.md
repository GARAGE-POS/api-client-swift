...
------------- | ------------- | -------------
[**getCities**](CitiesAPI.md#getcities) | **GET** /api/v1/cities | Get cities
[**getCityById**](CitiesAPI.md#getcitybyid) | **GET** /api/v1/cities/{CityID} | Get city by ID


# **getCities**
```swift
    open class func getCities(xAccountID: Int, xLocationID: Int, filters: String? = nil, page: Int? = nil, pageSize: Int? = nil, sortBy: String? = nil, sortDirection: String? = nil, completion: @escaping (_ data: PagedResultOfCityResponse?, _ error: Error?) -> Void)
```
...
// Get cities
CitiesAPI.getCities(xAccountID: xAccountID, xLocationID: xLocationID, filters: filters, page: page, pageSize: pageSize, sortBy: sortBy, sortDirection: sortDirection) { (response, error) in
...
[**PagedResultOfCityResponse**](PagedResultOfCityResponse.md)
...
# **getCityById**
```swift
    open class func getCityById(cityID: String, xAccountID: Int, xLocationID: Int, completion: @escaping (_ data: CityResponse?, _ error: Error?) -> Void)
```
...
let cityID = "cityID_example" // String | The unique identifier of the city
let xAccountID = 987 // Int | The account ID to operate under (Required)
let xLocationID = 987 // Int | The location ID to operate under (Required)

// Get city by ID
CitiesAPI.getCityById(cityID: cityID, xAccountID: xAccountID, xLocationID: xLocationID) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **cityID** | **String** | The unique identifier of the city | 
 **xAccountID** | **Int** | The account ID to operate under (Required) | 
 **xLocationID** | **Int** | The location ID to operate under (Required) | 
