...
public struct UpdateOAuth2ClientRequest: Sendable, Codable, Hashable {
    ...
    public init(displayName: String, clientType: String, clientSecret: String? = nil, redirectUris: [String], postLogoutRedirectUris: [String], permissions: [String], requirements: [String], consentType: String) {
