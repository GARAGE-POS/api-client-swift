//
// UpdateOAuth2ClientResponse.swift
//
...
public struct UpdateOAuth2ClientResponse: Sendable, Codable, Hashable {
    ...
    public init(ID: String, clientID: String, displayName: String, clientType: String, consentType: String, redirectUris: [String], postLogoutRedirectUris: [String], permissions: [String], requirements: [String], updatedAt: Date? = nil) {
        self.ID = ID
